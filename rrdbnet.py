...
class RRDBNet(nn.Module):
    def __init__(self, in_nc, out_nc,scale, nf, nb, gc=32,downsample=1.0):
    ...
    def forward(self, x):
        ...
        fea = self.downsample(fea)#self.lrelu(self.upconv2(F.interpolate(fea, scale_factor=2, mode='nearest')))
